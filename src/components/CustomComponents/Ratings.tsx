...
const ratingVariants = {
  ...
  gradient: {
    star: "text-transparent bg-clip-text bg-gradient-to-r from-[#EEB20A] via-[#FFC500] to-[#FFF582]",
    emptyStar: "text-muted-foreground",
  },
};
...
const Ratings = ({ ...props }: RatingsProps) => {
  ...
  return (
    <div className={cn("flex items-center gap-0")} {...props}>
