  ...
  return (
    <div className="flex w-full  gap-4 relative  bg-white flex-initial">
     ...
     <div className='flex  flex-col justify-center mt-10 ml-64'>
        <span style={{...labelStyle, color:'#6D6D6D'}} className='flex text-4xl text-center justify-center   w-36 '>SEO</span>
        <span className='flex text-4xl text-center justify-center   w-36 h-1 bg-[#631363] rounded-full' ></span>
...
export default SeoDesktopNavbar