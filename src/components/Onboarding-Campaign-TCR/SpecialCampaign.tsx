...
type SpecialCampaignProps = {
  specialCampaignType: boolean;
  setSpecialCampaignType: (value: boolean) => void;
};
  const SpecialCampaign:FC<SpecialCampaignProps> = ({specialCampaignType, setSpecialCampaignType}) => {
  
  return (
    <div className="flex flex-col justify-center items-center w-full h-full">
      <HeadBar
        title="Special Campaign Type "
        handleClick={() => setSpecialCampaignType(!specialCampaignType)}
      />
      {specialCampaignType && (
