        ...
        <div className="h-screen w-screen flex justify-center">
          <div className="h-full bg-cultured w-full px-5 relative">
            ...
            <div className="message-content-email mx-[5px] w-full mt-[10px]">
              <textarea className="px-[14px] py-[10px] h-auto w-full min-h-[80px]  outline-none border-none rounded-lg bg-white text-xs font-arial text-darkSilverColor"></textarea>
            </div>
          </div>
        </div>
      }
