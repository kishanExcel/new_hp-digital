    ...
    <div className={cn("p-3", className)}>
      <DayPicker
        ...
        classNames={{
          ...
          caption_label: "text-sm font-semibold text-[#631363]",
          ...
          cell: "h-9 w-9 text-center text-sm p-0 relative  [&:has([aria-selected].day-outside)]:bg-accent/50 [&:has([aria-selected])]:bg-accent border-0 text-[#6D6D6D] font-semibold rounded-none focus-within:relative focus-within:z-20",
          day: cn(
