...
import CCSaleDesktop from "../../paymentDesktop/transaction/ccSale";
                  ...
                  <div className=" px-[16px] py-[27px]">
                    ...
                    <div className="mt-[6px] ">
                      ...
                      {/* <div className='mt-[6px]'>
                                            ...
                                            <div className='w-full h-[27px] rounded-lg px-2 bg-[#F4F4F4]'>
                                                <CustomInput disabled={accessType === 'view'} model="surcharge_amount" value={formData.surcharge_amount} onChange={handleInputs} className='w-full text-[12px] bg-[#F4F4F4] h-full outline-none' id='invtitle' placeholder='' type='number' readOnly={false} />
                                            </div>
                                        </div> */}
                      ...
                      <div className="mt-[6px]">
                        ...
                        <div
                          className={`flex items-center text-[12px] w-full h-[27px] rounded-lg px-2 bg-[#F4F4F4] ${throwError && !formData.transaction_amount && "border border-red"}`}>
                          <span>$</span>
                          <CustomInput
                            disabled={accessType === "view"}
                      ...
                      <div className="flex items-center mt-[6px]">
                        <input
                          ...
                          checked={
                            formData.allow_partial_authorization_override
                          }
                          type="checkbox"
                          className="bg-limeGreen"
                        />
