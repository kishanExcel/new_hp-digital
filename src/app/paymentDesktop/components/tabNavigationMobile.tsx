          ...
          return (
            <div key={tab.tabName} className="h-full w-full">
              <Link
                ...
                <div
                  className={`h-full ripple w-full flex text-center justify-center items-center p-1 text-[14px] text-darkSilverColor ${roundedClass} ${query.tabName === tab.tabName ? "bg-limeGreen" : "bg-white"}`}>
