      ...
      Childrens={
        <div  className="flex-1 h-full  flex">
          ...
          <div className="relative h-full pb-[20px] overflow-y-auto overflow-x-hidden bg-cultured px-[15px]">
            ...
            <div className="flex items-center mt-[26px] 2xl:mt-[36] 2xl:mt[49px] justify-between">
            ...
            <div className="mt-[20px] 2xl:mt-[42px]  flex items-center">
              <button className="w-[510px] h-[40px] 2xl:h-[56px] bg-white text-darkSilverColor text-[18px] 2xl:text-[22px] flex justify-center items-center rounded-3xl">
                All incoming Activity
              </button>
            </div>
            <div className="flex justify-between mt-[20px] 2xl:mt-[35px] mb-[27px]">
              <h5 className="text-[16px] 2xl:text-[20px] text-darkSilverColor font-bold flex items-center">
              ...
              <h5 className="text-[16px] 2xl:text-[20px] text-darkSilverColor font-bold flex items-center">
                ...
                <span className="ml-[15px]">
                  <svg width="7" height="19" viewBox="0 0 7 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="flex-1 h-full  overflow-y-auto bg-white mx-2">
            <Chat />
          </div>
