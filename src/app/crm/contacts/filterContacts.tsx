...
const FilterContact: React.FC<FilterContactProps> = ({ setShowFilterCard }) => {
  return (
    <div className="absolute h-[70vh] z-[10] top-0 left-0 w-[220px] bg-[#F4F4F4] overflow-y-scroll overflow-x-hidden rounded-r-2xl border-palatinatePurple border-2">
      ...
      <FilterSection icon={TagIcon} title="Tags">
        <button className="bg-darkSilverColor rounded-xl block text-white font-bold mb-[6px] text-[8px] px-[6px] py-[5px]">
          football-fun
        </button>
        <button className="bg-palatinatePurple rounded-xl block text-white font-bold mb-[6px] text-[8px] px-[6px] py-[5px]">
          musician
        </button>
        <button className="bg-darkSilverColor rounded-xl block text-white font-bold mb-[6px] text-[8px] px-[6px] py-[5px]">
          football-fun
